...
const ATMCard = ({ atm }) => {
  ...
  return (
    <div className="relative my-4 w-64 rounded-lg bg-white py-6 px-6 shadow-md">
      ...
      {isCashFlowModalOpen && (
        <div className="fixed top-0 left-0 z-50 flex w-full items-center justify-center  bg-black bg-opacity-50">
          <div className=" h-screen w-1/2 rounded-lg bg-white p-6 font-semibold shadow-md">
